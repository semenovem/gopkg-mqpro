...
func (q *Queue) Rfh2Marshal(p map[string]interface{}) ([]byte, error) {
	var bufPros []byte
	...
	copy(b[:4], q.rfh2.StructId)
	endian.PutUint32(b[4:], uint32(q.rfh2.Version))
	endian.PutUint32(b[8:], uint32(l))
	endian.PutUint32(b[12:], uint32(q.rfh2.Encoding))
	endian.PutUint32(b[16:], uint32(q.rfh2.CodedCharSetId))
	copy(b[20:28], []byte(q.rfh2.Format + space8)[:8])
	endian.PutUint32(b[28:], uint32(q.rfh2.Flags))
	endian.PutUint32(b[32:], uint32(q.rfh2.NameValueCCSID))
